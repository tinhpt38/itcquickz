<template>
    <section class="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl lg:max-w-4xl">
            ...
            <figure class="mt-10">
                <blockquote class="text-center text-xl font-semibold leading-8 text-gray-900 sm:text-3xl sm:leading-9">
                ...
                <figcaption class="mt-10">
                    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                        ...
                        <div>
                            <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Số báo
                                danh</label>
                            <div class="mt-2 mb-4">
                                <input
                                    v-model="data.idnum"
                    ...
                    <div class="mt-4 flex items-center justify-center space-x-3 text-base">
                        <div class="font-semibold text-gray-900">Phần mềm thi trắc nghiệm</div>
                        ...
                        >
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Vui lòng kiểm tra lại thông tin số báo danh được thông báo, hoặc liên hệ Giám thị để
                                    biết thêm thông
                                    tin chi tiết.
                                </p>
                            </div>
